       ...
       // private final Move move = null;
        ...
        public ChessBoard(Activity a) {
               ...
               // setupBoard();
                 ...
                 */
                // ad
                com.google.ads.AdView av = new com.google.ads.AdView(mActivity, null);
                RelativeLayout.LayoutParams lParam = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, 50);
