...
public class BoardGameChess {
	...
	private final Plansza[][] square = new Plansza[8][8];
    ...
    public TextView whiteMarker, blackMarker, whiteMove, blackMove;
		...
		public BoardGameChess(Activity a) {
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    // plansza
                    for (int j = 0; j < 8; j++) {
                            square[i][j] = new Plansza(i, j, this, mActivity);
		...
		public void makeMove(RuchyPodstawowe move) {
		 ...
		 public void makeMoveWithPromote(Ruchy move, int promote, boolean whiteToMove) {
	            square[move.getToRow()][move.getToCol()]
